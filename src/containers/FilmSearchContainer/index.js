...
// import {dataTags, data, dataFilm} from '../../Constants/Films'
...
//         </Link>
//
//         {/*<i className={styles.styleIcons}></i>*/}
        ...
        const renderFilms = filtered.map((item, index) => {
            ...
            return (
                <FilmItem1
                    ...
                    // style={`${bookmarksPassive ? styles.bookmarksActive : styles.bookmarksPassive} }`}
